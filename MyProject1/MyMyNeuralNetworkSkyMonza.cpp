...
#include "MyMyNeuralNetworkSkyMonza.h"
#include<fstream>
#include<ctime>
#include<vector>
#include"MyMatrix.h"

UMyMyNeuralNetworkSkyMonza::~UMyMyNeuralNetworkSkyMonza() {}
...
void UMyMyNeuralNetworkSkyMonza::BeginPlay()
{
    Super::BeginPlay();
...
void UMyMyNeuralNetworkSkyMonza::sigmoid(matrix::MyMatrix<float>& a) {
...
matrix::MyMatrix<float>& UMyMyNeuralNetworkSkyMonza::Query(matrix::MyMatrix<float>& input) {
...
// Called every frame
void UMyMyNeuralNetworkSkyMonza::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FVector4 UMyMyNeuralNetworkSkyMonza::Query111(float forward, float rightdown, float rightup1, float rightup2, float leftup2, float leftup1, float leftdown, float newRight, float newLeft, float speed, float angle) {
