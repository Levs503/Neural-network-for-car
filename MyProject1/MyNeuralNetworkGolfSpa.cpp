...
#include "MyNeuralNetworkGolfSpa.h"
#include<fstream>
#include<ctime>
#include<vector>
#include"MyMatrix.h"

UMyNeuralNetworkGolfSpa::UMyNeuralNetworkGolfSpa()
{
    std::string filename = "GolfSpa.txt";
...
void UMyNeuralNetworkGolfSpa::sigmoid(matrix::MyMatrix<float>& a) {
...
void UMyNeuralNetworkGolfSpa::BeginPlay()
{
    Super::BeginPlay();
...
matrix::MyMatrix<float>& UMyNeuralNetworkGolfSpa::Query(matrix::MyMatrix<float>& input) {
...
// Called every frame
void UMyNeuralNetworkGolfSpa::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FVector4 UMyNeuralNetworkGolfSpa::Query111(float forward, float rightdown, float rightup1, float rightup2, float leftup2, float leftup1, float leftdown, float newRight, float newLeft, float speed, float angle) {
