...
#include "MyMyNeuralNetworkGolfMonza.h"
#include<fstream>
#include<ctime>
#include<vector>
#include"MyMatrix.h"

UMyMyNeuralNetworkGolfMonza::~UMyMyNeuralNetworkGolfMonza() {}
...
void UMyMyNeuralNetworkGolfMonza::BeginPlay()
{
    Super::BeginPlay();
...
void UMyMyNeuralNetworkGolfMonza::sigmoid(matrix::MyMatrix<float>& a) {
...
matrix::MyMatrix<float>& UMyMyNeuralNetworkGolfMonza::Query(matrix::MyMatrix<float>& input) {
...
// Called every frame
void UMyMyNeuralNetworkGolfMonza::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FVector4 UMyMyNeuralNetworkGolfMonza::Query111(float forward, float rightdown, float rightup1, float rightup2, float leftup2, float leftup1, float leftdown, float newRight, float newLeft, float speed, float angle) {
