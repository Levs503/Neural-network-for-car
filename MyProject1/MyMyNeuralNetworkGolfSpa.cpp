...
#include "MyMyNeuralNetworkGolfSpa.h"
#include<fstream>
#include<ctime>
#include<vector>
#include"MyMatrix.h"

UMyMyNeuralNetworkGolfSpa::~UMyMyNeuralNetworkGolfSpa() {}
...
void UMyMyNeuralNetworkGolfSpa::sigmoid(matrix::MyMatrix<float>& a) {
...
void UMyMyNeuralNetworkGolfSpa::BeginPlay()
{
    Super::BeginPlay();
...
matrix::MyMatrix<float>& UMyMyNeuralNetworkGolfSpa::Query(matrix::MyMatrix<float>& input) {
...
// Called every frame
void UMyMyNeuralNetworkGolfSpa::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FVector4 UMyMyNeuralNetworkGolfSpa::Query111(float forward, float rightdown, float rightup1, float rightup2, float leftup2, float leftup1, float leftdown, float newRight, float newLeft, float speed, float angle) {
