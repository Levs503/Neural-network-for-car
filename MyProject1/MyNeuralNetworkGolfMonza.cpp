...
#include "MyNeuralNetworkGolfMonza.h"
#include<fstream>
#include<ctime>
#include<vector>
#include"MyMatrix.h"

UMyNeuralNetworkGolfMonza::UMyNeuralNetworkGolfMonza()
{
    std::string filename = "GolfMonza.txt";
...
void UMyNeuralNetworkGolfMonza::BeginPlay()
{
    Super::BeginPlay();
...
void UMyNeuralNetworkGolfMonza::sigmoid(matrix::MyMatrix<float>& a) {
...
matrix::MyMatrix<float>& UMyNeuralNetworkGolfMonza::Query(matrix::MyMatrix<float>& input) {
...
// Called every frame
void UMyNeuralNetworkGolfMonza::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FVector4 UMyNeuralNetworkGolfMonza::Query111(float forward, float rightdown, float rightup1, float rightup2, float leftup2, float leftup1, float leftdown, float newRight, float newLeft, float speed, float angle) {
