...
#include "MyMyNeuralNetworkSkySpa.h"
#include<fstream>
#include<ctime>
#include<vector>
#include"MyMatrix.h"

UMyMyNeuralNetworkSkySpa::~UMyMyNeuralNetworkSkySpa() {}
...
void UMyMyNeuralNetworkSkySpa::sigmoid(matrix::MyMatrix<float>& a) {
...
void UMyMyNeuralNetworkSkySpa::BeginPlay()
{
    Super::BeginPlay();
...
matrix::MyMatrix<float>& UMyMyNeuralNetworkSkySpa::Query(matrix::MyMatrix<float>& input) {
...
// Called every frame
void UMyMyNeuralNetworkSkySpa::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
FVector4 UMyMyNeuralNetworkSkySpa::Query111(float forward, float rightdown, float rightup1, float rightup2, float leftup2, float leftup1, float leftdown, float newRight, float newLeft, float speed, float angle) {
